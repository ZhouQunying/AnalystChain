...
**原计划使用deepseek-v3但调整：**
- ❌ DeepSeek API不支持`deepseek-v3`型号名称
- ✅ `deepseek-chat`是官方稳定版本
- ✅ 性能满足知识提取需求
...
### 背景
需要选择Agent使用的LLM模型，根据已有API Key（DEEPSEEK_API_KEY、OPENAI_API_KEY）和项目需求。
